...
class model_code:
    ...
    '''
    def __init__(self,code,whichtype,gene_max,length): 
        assert whichtype in ["FullBinary","MinBinary","Int","None"], "Type of code must be one of 'FullBinary','MinBinary','Int'"
