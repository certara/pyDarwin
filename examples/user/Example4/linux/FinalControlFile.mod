...
$DATA      /home/ppolozov/darwin/examples/user/Example4/dmag_with_period.csv IGNORE=@
...
$INPUT       ID TIME AMT DROP DV MDV EVID WT AGE SEX BUN SCR OCC CRCL COV1 COV2
$DATA      /home/ppolozov/darwin/examples/user/Example4/dmag_with_period.csv IGNORE=@  REWIND
$MSFI = MSF1
