...
class MogaProblem(ElementwiseProblem):
    def __init__(self, n_var, modeltemplate, generation, n_eval):
        ...
        self.n_eval = n_eval
# X = MogaProblem( n_var, modeltemplate, generation, n_eval)
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        # copy x to self
        #self.
        # f1 =  run.result.condition_num
        f1 = run.result.ofv
        f2 = model.estimated_omega_num
...
def run_moga(model_template: Template) -> ModelRun:
    ...
    while runner.algorithm.has_next():
        ...
        print(runner.algorithm.n_gen, runner.algorithm.evaluator.n_eval)
