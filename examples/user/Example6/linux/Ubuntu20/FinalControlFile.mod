...
$DATA      /home/CertaraUser/Desktop/FDA-OGD-ML/examples/user/Example6/dataWithPeriod.csv IGNORE=@
...
$INPUT       ID TIME AMT DROP DV MDV EVID WT AGE SEX BUN SCR OCC CRCL COV1 COV2
$DATA      /home/CertaraUser/Desktop/FDA-OGD-ML/examples/user/Example6/dataWithPeriod.csv IGNORE=@  REWIND
$MSFI = MSF1
