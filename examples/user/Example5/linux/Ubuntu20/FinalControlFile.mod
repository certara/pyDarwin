...
$DATA      /home/CertaraUser/Desktop/FDA-OGD-ML/examples/user/Example5/dataWithPeriod.csv IGNORE=@
...
$PK
  ...
  TVV2=THETA(1)    *EXP(COV2*THETA(6))  *EXP(IOVV)
  V2=TVV2*EXP(ETA(2))
  IOVCL = 0
...
$THETA
  ...
  (-4,0.1) 	; THETA(6) EXPONENTIAL volume ~COV2 
...
;; Phenotype 
;; OrderedDict([('ADVAN', 1), ('K23~WT', 0), ('KAETA', 1), ('V2~WT', 0), ('V2~AGE', 0), ('V2~SEX', 0), ('V2~COV2', 1), ('CL~WT', 0), ('CL~AGE', 0), ('CL~CRCL', 0), ('CL~COV1', 0), ('IOVCL', 1), ('IOVV', 0), ('INITCL', 1), ('ETAD1LAG', 0), ('D1LAG', 0), ('RESERR', 0)])
;; Genotype 
